"""Test src/github_actions_workflow_linter/rules/underscore_outputs.py."""
...
from src.github_actions_workflow_linter.rules.underscore_outputs import RuleUnderscoreOutputs
